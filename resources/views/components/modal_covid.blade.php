...
<div id="covid_modal" class="modal fixed-right fade bd-example-modal-lg" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-aside modal-covid" role="document">
  <div class="modal-content ">
        <div class="modal-header">
        <img src="/assets/images/covidIcon.svg" class="mr-2 ml-0 my-auto" alt="">
          <h2 class="modal-title pl-4" id="exampleModalLabel">{{ $covid->title }}</h2>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
